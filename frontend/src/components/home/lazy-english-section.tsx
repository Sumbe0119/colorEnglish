        ...
        <div className="mb-4 flex flex-wrap items-end justify-between gap-4">
          <div>
            <h2 className="font-display text-3xl font-semibold text-mist-50 md:text-4xl">
              Learn from —{" "}
              <span key={active.id} className={`inline-block animate-fade-up ${active.accent.split(" ")[0]}`}>
                {active.label}
              </span>
            </h2>
            <p className="mt-3 max-w-xl text-mist-300">Та завгүй байсан ч болно өдөрт 10мин зарцуулахад л болно</p>
          </div>
        </div>
      </div>
    </section>
